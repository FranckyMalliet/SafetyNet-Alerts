...
public class DataDAOTest {
    ...
    private final static Logger logger = LoggerFactory.getLogger(DataDAOTest.class);
    ...
    public void writeAllDataTest(List<Person> personList, List<FireStation> fireStationList, List<MedicalRecord> medicalRecordsList){
