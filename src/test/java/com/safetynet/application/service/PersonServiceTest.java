...
@Service
public class PersonServiceTest implements IPersonServiceTest {

    private final static Logger logger = LoggerFactory.getLogger(PersonServiceTest.class);
    ...
    public List<Person> getPersonDataWithAddress(String address) {
        ...
        for (JsonNode personRoot : IUtilitiesServiceTest.getRootArray().path("persons")) {
    ...
    public List<Person> getAllPerson(){
        ...
        for (JsonNode root : IUtilitiesServiceTest.getRootArray().get("persons")) {
            Person personData = new Person();
    ...
    public List<List<String>> getFireStationResidentData(String fireStationNumber) {
        ...
        List<FireStation> fireStationList = IFireStationServiceTest.getFireStationInformationWithNumber(fireStationNumber);
        for(FireStation fireStationData : fireStationList){
            ...
            for(Person personData : personInformationList){
                MedicalRecord personMedicalRecord = IMedicalRecordServiceTest.getMedicalRecordDataWithFirstNameAndLastName(personData.getFirstName(), personData.getLastName());
                String personAge = IUtilitiesServiceTest.getPersonAge(personMedicalRecord.getBirthdate());
    ...
    public List<Person> getChildAlert(String address) {
        ...
        for(Person personData : personInformation){
            MedicalRecord personMedicalRecord = IMedicalRecordServiceTest.getMedicalRecordDataWithFirstNameAndLastName(personData.getFirstName(), personData.getLastName());
            if(Integer.parseInt(IUtilitiesServiceTest.getPersonAge(personMedicalRecord.getBirthdate())) <= 18){
                personList.add(personData);
            }
        }
    ...
    public List<List<String>> getMedicalInformationFromAddress(String address){
        ...
        for(Person personData : personList){
            ...
            MedicalRecord medicalRecordData = IMedicalRecordServiceTest.getMedicalRecordDataWithFirstNameAndLastName(personData.getFirstName(), personData.getLastName());
            personInformation.add(String.valueOf(IUtilitiesServiceTest.getPersonAge(medicalRecordData.getBirthdate())));
        ...
        List<String> fireStationList = IFireStationServiceTest.getFireStationNumberWithAddress(address);
    ...
    public List<List<String>> getAllPersonsDataFromAListOfFireStation(String stationNumber){
        ...
        List<String> fireStationAddressList = IFireStationServiceTest.getFireStationAddressWithNumber(stationNumber);
        for(String elements : fireStationAddressList){
            ...
            for(Person personData : personList){
                ...
                personInformation.add(IUtilitiesServiceTest.getPersonAge(medicalRecordData.getBirthdate()));
                List<String> medicationData = medicalRecordData.getMedications();
                List<String> allergiesData = medicalRecordData.getAllergies();
    ...
    public List<String> getEmailData(String city) {
        ...
        for (JsonNode root : IUtilitiesServiceTest.getRootArray().path("persons")) {
