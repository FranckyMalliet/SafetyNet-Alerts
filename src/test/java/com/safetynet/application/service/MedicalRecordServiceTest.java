...
@Service
public class MedicalRecordServiceTest implements IMedicalRecordServiceTest {

    private final static Logger logger = LoggerFactory.getLogger(MedicalRecordServiceTest.class);
    ...
    public MedicalRecord getMedicalRecordDataWithFirstNameAndLastName(String firstName, String lastName) {
        ...
        for (JsonNode medicalRecordRoot : IUtilitiesServiceTest.getRootArray().path("medicalrecords")) {
    ...
    public void deleteMedicalRecordData(String firstName, String lastName){
        ...
        dataDAOTest.writeAllDataTest(personList, fireStationList, newMedicalRecordList);
    }
